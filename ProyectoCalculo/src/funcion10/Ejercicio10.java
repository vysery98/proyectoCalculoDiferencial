...
public class Ejercicio10 {
    ...
    // Presentar tabla de valores de la funcion presentada. 
    public static void main(String[] args) {

        Scanner scan = new Scanner(System.in); // para lectura de datos

        System.out.println("\\_____EJERCICIO 10_____/");

        // función a realizar
        System.out.println("f(x)= (x^2+5)/(x^2-10)");
        ...
        do {
            ...
            switch (Variables.opt) {
                ...
                case 1: // Solo un Valor
                    ...
                    // proceso
                    Variables.varDep = (Math.pow(Variables.varInd, 2) + 5) / 
                            (Math.pow(Variables.varInd, 2) - 10);
                ...
                case 2: // Más de un valor
                    ...
                    for (int i = 0; i <= Variables.lim; i++) {
                        ...
                        Variables.y[i] = (Math.pow(Variables.limInf, 2) + 5) / 
                            (Math.pow(Variables.limInf, 2) - 10);
                        Variables.limInf++;
