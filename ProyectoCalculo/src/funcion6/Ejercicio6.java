...
public class Ejercicio6 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\\_____EJERCICIO 6_____/");

        // función a realizar
        System.out.println("f(x)= ((5x^2)/(x-1))^1/2");
        ...
        do {
            ...
            switch (Variables.opt) {
                ...
                case 1: // Solo un Valor
                    ...
                    // proceso
                    Variables.varDep = Math.sqrt((5*Math.pow(Variables.varInd, 
                            2))/(Variables.varInd - 1));
                ...
                case 2: // Más de un valor
                    ...
                    for (int i = 0; i <= Variables.lim; i++) {
                        ...
                        Variables.y[i] = Math.sqrt((5*Math.pow(Variables.limInf, 
                                2))/(Variables.limInf - 1));
                        Variables.limInf++;
